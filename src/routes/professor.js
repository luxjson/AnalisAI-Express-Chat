...
router.post('/dashboard/gerar-senha-aluno/:id', checkAuth, professorController.gerarSenhaAluno);
...
router.post('/dashboard/deletar-competencia/:id', checkAuth, professorController.deletarCompetencia);
...
router.post('/dashboard/delete-aluno/:id', checkAuth, professorController.deleteAluno);
