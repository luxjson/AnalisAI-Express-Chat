...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (configLink) {
        ...
        configLink.addEventListener('click', (event) => {
            ...
            window.dispatchEvent(new CustomEvent('analisai:open-settings', { detail: { section: 'notifications' } }));
        });
    }
